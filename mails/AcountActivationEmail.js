...
export const AccountActivationEmail = async (email, data) => {
  ...
  const transport = nodemailer.createTransport({
    ...
    port: 587,
    auth: {
      user: "developergoutam53@gmail.com",
      pass: "zqga slft yqkh mlxq",
    },
  });
  await transport.sendMail({
    from: "Blood Donation <developergoutam53@gmail.com>",
    subject: "Activate",
    to: email,
    html: `
...
<div align="center" class="alignment" style="line-height:10px"><img alt="I'm an image" src="https://c8.alamy.com/comp/PP9KH2/donate-blood-concept-with-blood-bag-and-heart-blood-donation-vector-illustration-isolated-on-white-background-world-blood-donor-day-june-14-PP9KH2.jpg" style="display: block; height: auto; border: 0; max-width: 120px; width: 100%;" title="I'm an image" width="120"/></div>
</td>
</tr>
</table>
...
<p style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 19.2px;"><strong> Hello ${data.name}, Please Activate your Account</strong></p>
</div>
</div>
</td>
</tr>
...
<div style="font-family: sans-serif">
<div class="" style="font-size: 12px; font-family: Arial, Helvetica, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #555555; line-height: 1.2;">
<p style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 16.8px;"> Blood donation saves lives. Each donation is a precious and generous gift which can save or improve the lives of up to three seriously ill adults (or six sick children), Thank you. </p>
</div>
</div>
</td>
</tr>
